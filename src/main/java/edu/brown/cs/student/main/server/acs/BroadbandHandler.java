...
public class BroadbandHandler implements Route {
     ...
     * @param cache  Whether to use caching. If true, an ACSAPICacheProxy is used. The developer may specify the parameters.
     */
    ...
    /**
     * Handles an incoming request for broadband data by fetching data from the ACS API
    ...
    public Object handle(Request request, Response response) {
        ...
        try {
            ...
            return BroadbandFailureResponse("Failed to retrieve data for given state and county: "
                    + e.getMessage());
        }
    }
