...
/**
 * Handler for the viewCSV API endpoint. This class is responsible for returning the contents of the
 * loaded CSV file.
 */
public class ViewCSVHandler implements Route {
  ...
  /**
   * Handles the incoming request to view the loaded CSV file. If no CSV file has been loaded, it
   * returns an error response. Otherwise, it returns a success response containing the CSV data.
   *
